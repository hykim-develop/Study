...
### 📌 Description
* Python, MySQL 및 데이터 수집
* 데이터 수집 및 Tableu 기반 데이터 시각화
* 머신러닝∙딥러닝 기초
* LLM 모델 기반 통계 및 딥러닝 기반 자연어처리
...
## 📂 Metacode Folder
데이터 엔지니어링 관련 학습 및 프로젝트를 정리한 폴더입니다.

### 📌 Description
* 파이썬 및 SQL 데이터 스토리지, 처리 및 분석 자동화 실습
* DAG 개발 및 최적화, Spark 데이터 처리, 최적화 및 실전 프로젝트, Docker 컨테이너 운영, 네트워크, 스토리지 및 자동화 실습
* AWS 기반 Docker 및 데이터 엔지니어링, K8S 아키텍처, 클러스터 구축 및 네트워크 실습
* K8S - 스토리지, AWS 배포 및 데이터 엔지니어링
* Kafka 아키텍처, 프로듀서-컨슈머 개발 및 데이터 연동
...
![AWS SDK & CLI](https://img.shields.io/badge/AWS_SDK_&_CLI-232F3E?style=for-the-badge&logo=amazonaws&logoColor=white)
...
## 🚀 Goal
데이터 분석부터 데이터 엔지니어링까지 전반적인 데이터 역량을 쌓는 것을 목표로 합니다.
